...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference("MenuItem.count") do
      post menu_items_url, params: { menu_item: { available: @menu_item.available, category_id: @menu_item.category_id, description: @menu_item.description, name: @menu_item.name, price: @menu_item.price } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { available: @menu_item.available, category_id: @menu_item.category_id, description: @menu_item.description, name: @menu_item.name, price: @menu_item.price } }
